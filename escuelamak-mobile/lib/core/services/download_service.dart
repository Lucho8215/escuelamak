  ...
  static Future<String?> downloadFile(String url, String fileName) async {
    try {
      ...
      if (uri == null || !uri.hasScheme) {
        debugPrint('DownloadService: URL inválida: $url');
        return null;
      }
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint(
            'DownloadService: Error HTTP ${response.statusCode} para URL: $url');
        return null;
      }
    } on SocketException catch (e) {
      debugPrint('DownloadService: Error de red - ${e.message}');
      return null;
    } on FileSystemException catch (e) {
      debugPrint(
          'DownloadService: Error de sistema de archivos - ${e.message}');
      return null;
    } on FormatException catch (e) {
      debugPrint('DownloadService: Error de formato - ${e.message}');
      return null;
    } catch (e) {
      debugPrint('DownloadService: Error inesperado - $e');
      return null;
    }
  }
